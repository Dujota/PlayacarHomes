...
import { ContactCardProps } from '../cards/ContactCard';
    ...
    <>
      ...
      >
        ...
        <div className='flex flex-row flex-wrap items-center justify-center gap-[11.31rem] self-stretch overflow-hidden text-[0.94rem] md:w-auto md:gap-[5rem] md:self-stretch'>
          ...
          <FooterNav links={footerNavLinks} toggle={() => setShowModal(true)} />
          <FooterNav links={footerNavAltLinks} toggle={() => setShowModal(true)} />
        </div>
