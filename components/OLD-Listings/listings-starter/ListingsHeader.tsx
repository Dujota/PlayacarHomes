...
export default function ListingsHeader({ title, description, level }: { title: string; description?: any[]; level: 1 | 2 }) {
  switch (level) {
    case 1:
      return (
        <header className='mb-10 mt-16 flex flex-col items-center md:mb-12 md:flex-row md:justify-between'>
          <h1 className='text-6xl font-bold leading-tight tracking-tighter md:pr-8 md:text-8xl'>{title}</h1>
